                ...
                <form action="<?php echo URL; ?>listings/createpropertyimages" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="panel-body"> 
                        ...
                        <div class="form-group col-lg-1" type="hidden">
                            <label for="image_type" type="hidden"></label>
                            <input type="hidden" name="image_type" value="REGULAR">
                        </div>
                    ...
                    <div class="panel-footer clearfix">
                        <div class="pull-right">  
                            <button class="btn btn-lg btn-warning active" type="submit" name="submit_create_image" >Add & Next Image </button>
                            <button class="btn btn-lg btn-success active" type="submit" name="submit_done" href="<?php echo URL . "listings/listingcomplete" ?>">Add & Finish </button>
                        </div>    
                    </div>
                </form>
            </div>
